...
exports.resolvers = {
    Query: Object.assign(Object.assign({ info: (parent, args, context) => {
        ...
        }, test: (parent, args, context) => `This is the parent: ${parent}. These are the ${args}. This is the ${context}. This works!` }, userController_1.userResolvers.Query), orderController_1.orderResolvers.Query),
