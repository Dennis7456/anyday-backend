...
export type FileValueResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['FileValue'] = ResolversParentTypes['FileValue'],
> = {
  id?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
> = {
  attachFiles?: Resolver<
    ResolversTypes['Order'],
    ParentType,
    ContextType,
    RequireFields<MutationAttachFilesArgs, 'input'>
  >
  completeRegistration?: Resolver<
    ResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<MutationCompleteRegistrationArgs, 'input'>
  >
  createAssignment?: Resolver<
    ResolversTypes['Assignment'],
    ParentType,
    ContextType,
    RequireFields<MutationCreateAssignmentArgs, 'orderId' | 'writerId'>
  >
  ...
  register?: Resolver<
    ...
    >
  >
  registerAndCreateOrder?: Resolver<
    ResolversTypes['RegisterOrderResponse'],
    ParentType,
    ContextType,
    RequireFields<MutationRegisterAndCreateOrderArgs, 'input'>
  >
...
> = {
  ...
  uploadedFiles?: Resolver<
    Array<ResolversTypes['FileValue']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type RegisterOrderResponseResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['RegisterOrderResponse'] = ResolversParentTypes['RegisterOrderResponse'],
> = {
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>
